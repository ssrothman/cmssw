...
//
//  std::vector<edm::EDGetTokenT<SimHitCollection>> simhitCollectionTokens_;
//  edm::EDGetTokenT<std::vector<SimTrack> simtrackCollectionToken_;
//};
//
...
//
//  // Go ahead and put a std::unordered_map<size_t, PCaloHit> into the event
//  // Also put edm::Association SimHit --> SimTrack
//  //
//  // Producer for Association Hit --> SimCluster reads unordered_map, then loops through hits_and_fractions of SC
//  // 
//  // New producer for SimHit --> RecHit and RecHit --> SimHits
//  // Another producer for RecHit --> SimClusters from reading associations
//  //
//  // Add variable in SimCluster nano table for whether it should be kept or not
//
