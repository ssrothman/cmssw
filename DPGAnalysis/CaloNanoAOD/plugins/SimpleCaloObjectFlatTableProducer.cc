...
typedef SimpleFlatTableProducer<EcalRecHit> SimpleEcalRecHitFlatTableProducer;

#include "DataFormats/HcalRecHit/interface/HBHERecHit.h"
typedef SimpleFlatTableProducer<HBHERecHit> SimpleHBHERecHitFlatTableProducer;
...
typedef SimpleFlatTableProducer<HORecHit> SimpleHORecHitFlatTableProducer;

#include "DataFormats/ParticleFlowReco/interface/PFRecHit.h"
typedef SimpleFlatTableProducer<reco::PFRecHit> SimplePFRecHitFlatTableProducer;
...
DEFINE_FWK_MODULE(SimpleEcalRecHitFlatTableProducer);
DEFINE_FWK_MODULE(SimpleHBHERecHitFlatTableProducer);
DEFINE_FWK_MODULE(SimpleHORecHitFlatTableProducer);
DEFINE_FWK_MODULE(SimpleHFRecHitFlatTableProducer);
DEFINE_FWK_MODULE(SimplePFRecHitFlatTableProducer);
