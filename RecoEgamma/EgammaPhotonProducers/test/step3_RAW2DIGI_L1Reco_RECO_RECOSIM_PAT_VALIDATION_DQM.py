...
# with command line options: step3 -s RAW2DIGI,L1Reco,RECO,RECOSIM,PAT,VALIDATION:@standardValidationNoHLT+@miniAODValidation,DQM:@standardDQMFakeHLT+@miniAODDQM --conditions auto:phase1_2018_realistic --datatier GEN-SIM-RECO,MINIAODSIM,DQMIO -n 10 --eventcontent RECOSIM,MINIAODSIM,DQM --geometry DB:Extended --era Run2_2018 --procModifiers enableSonicTriton,photonDRN --filein file:step2.root --fileout file:step3.root
...
process.TritonService.fallback.imageName = 'nvcr.io/nvidia/tritonserver:22.09-pyt-python-py3'
